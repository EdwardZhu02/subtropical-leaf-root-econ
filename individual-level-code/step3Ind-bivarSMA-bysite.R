...
suppressWarnings(ggsave(plot = smaplt.LNC_LMA, filename = "individual-level-code/IndSites_sma.LNC_LMA.pdf", width = 2.8, height = 2.8))
...
suppressWarnings(ggsave(plot = smaplt.RD_SRL, filename = "individual-level-code/IndSites_sma.RD_SRL.pdf", width = 2.8, height = 2.8))
...
suppressWarnings(ggsave(plot = smaplt.RNC_RTD, filename = "individual-level-code/IndSites_sma.RNC_RTD.pdf", width = 2.8, height = 2.8))
...
suppressWarnings(ggsave(plot = smaplt.Ld13C_LA, filename = "individual-level-code/IndSites_sma.Ld13C_LA.pdf", width = 2.8, height = 2.8))
...
suppressWarnings(ggsave(plot = smaplt.Ld13C_RCC, filename = "individual-level-code/IndSites_sma.Ld13C_RCC.pdf", width = 2.8, height = 2.8))
...
suppressWarnings(ggsave(plot = smaplt.Ld13C_RPC, filename = "individual-level-code/IndSites_sma.Ld13C_RPC.pdf", width = 2.8, height = 2.8))
...
suppressWarnings(ggsave(plot = smaplt.Rdark25P_SRR25, filename = "individual-level-code/IndSites_sma.Rdark25P_SRR25.pdf", width = 2.8, height = 2.8))
...
suppressWarnings(ggsave(plot = smaplt.RNC_LNC, filename = "individual-level-code/IndSites_sma.RNC_LNC.pdf", width = 2.8, height = 2.8))
...
suppressWarnings(ggsave(plot = smaplt.SRL_SLA, filename = "individual-level-code/IndSites_sma.SRL_SLA.pdf", width = 2.8, height = 2.8))
