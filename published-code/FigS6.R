...
ggsave(plot=plt_END_RLESaltpred , filename = "outplts/SIFigures/FigS6A-END_RLESaltpred.pdf", width = 7.5, height = 3.5)
...
ggsave(plot=plt_END_RESLESorthog, filename = "outplts/SIFigures/FigS6B-END_RESLESorthog.pdf", width = 7, height = 3.5)
