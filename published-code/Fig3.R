...
# Variance explained in each axis are computed in 
# 3-calculate-PCA-nonphylo.R and 4-calculate-PCA-phylo.R, and here we just input the data for plotting.

if (!dir.exists("outplts/Fig3")) {
  dir.create("outplts/Fig3", showWarnings = FALSE, recursive = TRUE)
}
...
plt_scree_compare = ggplot(screeData_compare_touse) +
  ...
  labs(title="Markers only", y="Variance Explained (%)") + 
  theme_classic() +
...
ggsave(filename = "outplts/Fig3/Fig3A-Ind_varaxes-RLES.pdf", plot = plt_scree_compare, width = 3.9, height = 3.5)

# Fig 3B: Markers + LES co-predictors ------------------------------------------
screeData_compare_touse = screeData_compare_RLES_leaf_copred
screeData_compare_touse = melt(screeData_compare_touse,variable.name="Category",value.name = "ExplainedVariance")
...
plt_scree_compare = ggplot(screeData_compare_touse) +
  ...
  geom_text(aes(x = Dimensions, y = ExplainedVariance, group = Category, label = paste0(ExplainedVariance, "%")),
            position = position_dodge(width = 0.6),size = 3.5,vjust = 0.8,hjust=-0.7,angle=90) + 
  labs(title="Markers + LES co-predictors", y="Variance Explained (%)") + 
  theme_classic() +
  scale_y_continuous(limits = c(0, 42), expand = c(0, 0)) + # Removes the blank space
  theme(legend.title = element_blank(), 
        legend.position = c(1, 1),
...
ggsave(filename = "outplts/Fig3/Fig3B-Ind_varaxes-RLES-leaf.pdf", plot = plt_scree_compare, width = 3.9, height = 3.5)

# Fig 3C: Markers + root co-predictors -----------------------------------------
screeData_compare_touse = screeData_compare_RLES_root_copred
screeData_compare_touse = melt(screeData_compare_touse,variable.name="Category",value.name = "ExplainedVariance")
...
plt_scree_compare = ggplot(screeData_compare_touse) +
  ...
  geom_text(aes(x = Dimensions, y = ExplainedVariance, group = Category, label = paste0(ExplainedVariance, "%")),
            position = position_dodge(width = 0.6),size = 3.5,vjust = 0.8,hjust=-0.7,angle=90) + 
  labs(title="Markers + RES co-predictors", y="Variance Explained (%)") + 
  theme_classic() +
  scale_y_continuous(limits = c(0, 42), expand = c(0, 0)) + # Removes the blank space
  theme(legend.title = element_blank(), 
        legend.position = c(1, 1),
...
ggsave(filename = "outplts/Fig3/Fig3C-Ind_varaxes-RLES-root.pdf", plot = plt_scree_compare, width = 3.9, height = 3.5)

# Fig 3D: Markers + all co-predictors ------------------------------------------
...
plt_scree_compare = ggplot(screeData_compare_touse) +
  ...
  geom_text(aes(x = Dimensions, y = ExplainedVariance, group = Category, label = paste0(ExplainedVariance, "%")),
            position = position_dodge(width = 0.6),size = 3.5,vjust = 0.8,hjust=-0.7,angle=90) + 
  labs(title="Markers + all co-predictors", y="Variance Explained (%)") + 
  theme_classic() +
  scale_y_continuous(limits = c(0, 42), expand = c(0, 0)) + # Removes the blank space
  theme(legend.title = element_blank(), 
        legend.position = c(1, 1),
...
ggsave(filename = "outplts/Fig3/Fig3D-Ind_varaxes-RLES-all.pdf", plot = plt_scree_compare, width = 3.9, height = 3.5)