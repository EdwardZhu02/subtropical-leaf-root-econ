...
# PART 1: Prepare data for main analysis ---------------------------------------
...
# Statistics for individual-level data 
...
save(traitDataIndv, traitDataIndv_SelectedTraits_spavg,
     ...
     file = "outdata/traitDataFujian-SpAvg-step1.RData")


# PART 2: Prepare data for phylotree construction ------------------------------
# Species-level, code is modified, retaining original suffix '_Indv'
traitDataIndv = readxl::read_xlsx("rawdata/traits-individual.xlsx")
traitDataIndv_colcaption = traitDataIndv[1,]
traitDataIndv = traitDataIndv[-1,] 
...
save(traitDataIndv, #traitDataIndv_colcaption,
     ...
     file = "outdata/traitDataFujian-phylotree-step1.RData")
