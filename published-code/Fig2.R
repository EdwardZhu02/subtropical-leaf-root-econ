...
if (!dir.exists("outplts/Fig2")) {
  dir.create("outplts/Fig2", showWarnings = FALSE, recursive = TRUE)
}
...
ggsave(plot = plt_ax123_bi_varimax, filename = "outplts/Fig2/Fig2AB-Ind_nonphyPCA_bi_LES.pdf",
       width = 7.5, height = 4.5)

# Fig 2D-E: Root trait space ---------------------------------------------------
...
plt_ax123_bi_varimax = plt_nonphyloPCA_biplot_ax12.varimax + plt_nonphyloPCA_biplot_ax23.varimax +
  plot_layout(guides = "collect") & theme(legend.position='bottom')
ggsave(plot = plt_ax123_bi_varimax, filename = "outplts/Fig2/Fig2DE-Ind_nonphyPCA_bi_RES.pdf",
       width = 7.5, height = 4.5)

# Fig 2G-H: Leaf + Root trait space --------------------------------------------
...
plt_ax123_bi_varimax = plt_nonphyloPCA_biplot_ax12.varimax + plt_nonphyloPCA_biplot_ax23.varimax +
  plot_layout(guides = "collect") & theme(legend.position='bottom')
ggsave(plot = plt_ax123_bi_varimax, filename = "outplts/Fig2/Fig2GH-Ind_nonphyPCA_bi_RLES.pdf",
       width = 7.5, height = 4.5)
