...
suppressWarnings(ggsave(plot=plt_htmap_lambda, filename="outplts/SIFigures/FigS5A-PGLS-lambda.pdf", width=5.3, height=4.3))
...
suppressWarnings(ggsave(plot=plt_htmap_pvalue, filename="outplts/SIFigures/FigS5B-PGLS-pvalue.pdf", width=6.3, height=3))
...
suppressWarnings(ggsave(plot=plt_htmap_rsq, filename="outplts/SIFigures/FigS5C-PGLS-rsq.pdf", width=6.3, height=3))
